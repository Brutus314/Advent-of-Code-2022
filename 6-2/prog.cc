...
int main() {
    ...
    for (startingOffset = 0; startingOffset + 14 < input.length(); startingOffset++) {
        if (stringHasUniqueCharacters(input.substr(startingOffset, 14))) {
            break;
        }
    }

    cout << startingOffset + 14 << endl;
