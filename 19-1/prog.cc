...
int findGeodesInTime(Blueprint& blueprint, int timeLeft = 24, 
...
int findGeodesInTime(Blueprint& blueprint, int timeLeft, 
    ...
    int geodeYield = 0;if (!declinedOreRobot && oreOnHand >= blueprint.oreRobotOreCost && ((timeLeft * oreRobots) + oreOnHand) < (timeLeft * blueprint.highestOreCost())) {
        // Build an ore robot
